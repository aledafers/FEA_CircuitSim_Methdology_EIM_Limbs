...
wm = [8e-3 10e-3 12e-3 14e-3 16e-3];
wf0 = 4e-3;
wm0 = 8e-3;
...
% a_comsol_cad_2cm = csvread('mag_comsol_arm_2cm.csv',1,1);
% p_comsol_cad_2cm = csvread('pha_comsol_arm_2cm.csv',1,1);
% a_comsol_cad_4cm = csvread('mag_comsol_arm_4cm.csv',1,1);
% p_comsol_cad_4cm = csvread('pha_comsol_arm_4cm.csv',1,1);
...
grid minor
title('Upper Arm Bioimpedance Spectrum - Magnitude - Changes in Fat Thickness')
...
hAx.ColorOrder = [0 0.4470 0.7410; 0.8500 0.3250 0.0980; 0.9290 0.6940 0.1250; 0.4940 0.1840 0.5560; 0.4660 0.6740 0.1880];
grid minor
title('Upper Arm Bioimpedance Spectrum - Phase - Changes in Fat Thickness')
...
figure('WindowState','maximized')
sgtitle('Upper Arm Circuit Model Parameters - 4 cm IED','FontSize',20)
subplot(2,3,1)
grid minor
ylabel('R_{1} [Ohm]')
xlabel('t_f [mm]')
...
figure('WindowState','maximized')
sgtitle('Upper Arm Circuit Model Parameters - 2.5 cm IED','FontSize',20)
subplot(2,3,1)
grid minor
ylabel('R_{1} [Ohm]')
xlabel('t_f [mm]')
...
hAx.ColorOrder = [0 0.4470 0.7410; 0.8500 0.3250 0.0980; 0.9290 0.6940 0.1250; 0.4940 0.1840 0.5560; 0.4660 0.6740 0.1880];
grid minor
title('Upper Arm Bioimpedance Spectrum - Magnitude - Changes in Muscle Thickness')
ylabel('Magnitude [Ohm]')
xlabel('Frequency [Hz]')
set(gca,'FontSize',20); hold all
...
% legend('FEA - 4 cm IED - tm = 8mm',...
%        'FEA - 4 cm IED - tm = 10mm',...
%        'FEA - 4 cm IED - tm = 12mm',...
%        'FEA - 4 cm IED - tm = 14mm',...
%        'FEA - 4 cm IED - tm = 16mm',...
%        'Circuit Model - 4 cm IED - tm = 8mm',...
%        'Circuit Model - 4 cm IED - tm = 10mm',...
%        'Circuit Model - 4 cm IED - tm = 12mm',...
%        'Circuit Model - 4 cm IED - tm = 14mm',...
%        'Circuit Model - 4 cm IED - tm = 16mm','Location','northeast')
% print -depsc m_arm_tm
...
hAx.ColorOrder = [0 0.4470 0.7410; 0.8500 0.3250 0.0980; 0.9290 0.6940 0.1250; 0.4940 0.1840 0.5560; 0.4660 0.6740 0.1880];
grid minor
title('Upper Arm Bioimpedance Spectrum - Phase - Changes in Muscle Thickness')
ylabel('Phase [Degrees]')
xlabel('Frequency [Hz]')
set(gca,'FontSize',20); hold all
...
%        'Circuit Model - 4 cm IED - tm = 12mm',...
%        'Circuit Model - 4 cm IED - tm = 14mm',...
%        'Circuit Model - 4 cm IED - tm = 16mm','Location','northwest')
% print -depsc p_arm_tm
